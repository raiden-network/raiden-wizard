...
def create_desktop_icon(target: pathlib.Path, symlink_name: str) -> None:
    ...
    desktop_icon_path = pathlib.Path.home().joinpath('Desktop', symlink_name)
    if desktop_icon_path.exists():
        desktop_icon_path.unlink()
    return desktop_icon_path.symlink_to(target)
